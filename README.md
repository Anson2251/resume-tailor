...
2. **Create a profile per target role** — each profile saves its own *view*: which items are shown, in what order, plus its own job title, summary, template, accent color, and font.
