		...
		<div class="px-9 pt-4 pb-5" :class="columns === 2 ? 'resume-columns' : ''">
			<template v-for="sid in orderedSections" :key="sid">
				<section v-if="sid === 'summary' && resume.contact.summary && sectionVisible('summary')" class="avoid-break">
					<h2 class="mb-2 text-xs font-bold tracking-[0.18em] uppercase" :style="{ color: accent }">{{ sectionTitle('summary', 'Summary') }}</h2>
				...
				<section v-else-if="sid === 'education' && shown.education.length && sectionVisible('education')" class="pt-4">
					<h2 class="mb-2 text-xs font-bold tracking-[0.18em] uppercase" :style="{ color: accent }">{{ sectionTitle('education', 'Education') }}</h2>
			...
			<section v-else-if="sid === 'experience' && shown.experience.length && sectionVisible('experience')" class="pt-4">
				<h2 class="mb-2 text-xs font-bold tracking-[0.18em] uppercase" :style="{ color: accent }">{{ sectionTitle('experience', 'Experience') }}</h2>
				<div class="entry-stack-sm">
			...
			<section v-else-if="sid === 'projects' && shown.projects.length && sectionVisible('projects')" class="pt-4">
				<h2 class="mb-2 text-xs font-bold tracking-[0.18em] uppercase" :style="{ color: accent }">{{ sectionTitle('projects', 'Projects') }}</h2>
				<div class="entry-stack-sm">
			...
			<section v-else-if="sid === 'skills' && shown.skills.length && sectionVisible('skills')" class="pt-4">
				<h2 class="mb-2 text-xs font-bold tracking-[0.18em] uppercase" :style="{ color: accent }">{{ sectionTitle('skills', 'Skills') }}</h2>
				<div class="entry-stack-sm">
			...
			<section v-else-if="customSection(sid) && customSection(sid).items.length && sectionVisible(sid)" class="pt-4">
				<h2 class="mb-2 text-xs font-bold tracking-[0.18em] uppercase" :style="{ color: accent }">{{ customSection(sid).title }}</h2>
				<div class="entry-stack-sm">
